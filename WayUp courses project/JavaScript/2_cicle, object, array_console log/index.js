...
function newUser (firstname, lastname, age, animal) {
    return {
        firstname,
        lastname,
        age,
...
user = newUser("Helen", "Starikova", 32, true);
...
text.push(array[3], array[7], array[0], array[8], array[11], array[5], array[9], array[6], array[4], array[1], array[12], array[2], array[10]);
